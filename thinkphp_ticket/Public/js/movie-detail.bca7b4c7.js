webpackJsonp([8], {
    0: function (t, i, e) {
        ...
        function h() {
            var t = arguments.length <= 0 || void 0 === arguments[0] ? system.myComment : arguments[0], i = t.score,
                e = void 0 === i ? 0 : i, s = t.content, o = void 0 === s ? "" : s;
            e ? (j.addClass("active"), C.text(2 * e + "分，" + n(2 * e)), w.addClass("active").data("score", e).data("wish", !1), T.text("看过")) : (j.removeClass("active"), C.text("评分"), w.data("score", 0)), r(), o ? B.text("我的短评") : B.text("写短评")
        }
        ...
        function d(t) {
            S && $(this).on("click", function () {
                ...
                }(), $(this).lightGallery($.extend({}, S, {index: t})).on("onAfterOpen.lg", g.disableScroll).on("onCloseAfter.lg", g.enableScroll)
            })
        }

        e(300), e(301);
        var p = e(31), u = e(302), c = e(29), m = s(c), g = e(33);
        e(39), e(41), e(192), e(42);
        var f = e(303), b = $(document), y = $(window), v = e(305),
            ...
            _ = function () {
                ...
                return function (i, e) {
                    ...
                    return s = e ? $.ajax({
                        method: "PUT",
                        url: "/ajax/proxy/mmdb/comment/" + x + "/" + e + ".json",
                        data: $.extend({}, t, i),
                        dataType: "json"
                    }) : $.post("/ajax/proxy/mmdb/comments/movie/" + x + ".json", $.extend({}, t, i)), s.then(function (t) {
        ...
        })), w.on("click", (0, p.checkLogin)((0, u.noRepeatRequest)(function (t) {
            var i = $(this);
            if (i.data("score"))return _({score: 0, content: ""}, system.myComment.id).then(function (t) {
                t.error || (l(), j.data("jBoxWidget").commentForm.scoreStarWidget.enable())
            });
        ...
        B.on("click", function () {
            j.trigger("click")
        }), j.on("click", (0, p.checkLogin)(function () {
            ...
            return $.post("/ajax/proxy/mmdb/approve/comment/" + e + ".json", {
        ...
        var D = system.imgs, S = null, L = {};
        D && D.length && ((0, m["default"])(function (t) {
            L = D.map(function (i) {
        ...
        function jBox(type, options) {
            ...
            return this.IE8 = userAgent.indexOf("msie") != -1 && 8 == parseInt(userAgent.split("msie")[1]), this.prefix = userAgent.indexOf("webkit") != -1 ? "-webkit-" : "", this._getOpp = function (t) {
                ...
                var e = i.top > this.pos.top - (this.options.adjustDistance.top || 0),
                    ...
                    a = n ? "left" : s ? "right" : null, r = e ? "top" : o ? "bottom" : null, h = a || r;
                if (h) {
