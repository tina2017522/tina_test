!function (e) {
    ...
    var u = n(32), d = r(u), l = "https://passport.meituan.com/account/unitivelogin", c = "/passport/login",
        _ = "https://passport.meituan.com/account/signout", m = "/passport/logout";
    ...
    !function (t, n) {
        ...
        function p(e, t, n, r) {
            var a, i = 1, s = 20, o = r ? function () {
                    ...
                    return ye.css(e, t, "")
                }, u = o(), d = n && n[3] || (ye.cssNumber[t] ? "" : "px"),
                l = (ye.cssNumber[t] || "px" !== d && +u) && ze.exec(ye.css(e, t));
            if (l && l[3] !== d) {
                d = d || l[3], n = n || [], l = +u || 1;
        ...
        function z(e, t, n) {
            var r = !0, a = "width" === t ? e.offsetWidth : e.offsetHeight, i = Mt(e),
        ...
        function U(e, t, n) {
            var r, a, i, s, o, u, d, l, c = this, _ = {}, m = e.style, h = e.nodeType && Re(e),
                f = ye._data(e, "fxshow");
        ...
        var se = [], oe = n.document, ue = se.slice, de = se.concat, le = se.push, ce = se.indexOf, _e = {},
            me = _e.toString, he = _e.hasOwnProperty, fe = {}, pe = "1.12.4", ye = function (e, t) {
            ...
            function (e) {
                ...
                function y(e, t, n, a, i, s) {
                    return a && !a[N] && (a = y(a)), i && !i[N] && (i = y(i, s)), r(function (r, s, o, u) {
                        var d, l, c, _ = [], m = [], h = s.length, y = r || f(t || "*", o.nodeType ? [o] : o, []),
                            M = !e || !r && t ? y : p(y, _, e, o, u), L = n ? i || (r ? e : h || a) ? [] : s : M;
                ...
                function L(e, n) {
                    var a = n.length > 0, i = e.length > 0, s = function (r, s, o, u, d) {
                        var l, c, _, m = 0, h = "0", f = r && [], y = [], M = x, L = r || i && Y.find.TAG("*", d),
                            g = I += null == M ? 1 : Math.random() || .1, v = L.length;
                ...
                var g, v, Y, k, w, D, T, b, x, S, H, j, E, A, P, W, C, F, O, N = "sizzle" + 1 * new Date,
                    z = e.document, I = 0, R = 0, J = n(), q = n(), U = n(), V = function (e, t) {
                        return e === t && (H = !0), 0
                    }, G = 1 << 31, $ = {}.hasOwnProperty, B = [], X = B.pop, K = B.push, Q = B.push, Z = B.slice,
                    ee = function (e, t) {
                    ...
                    le = new RegExp("=" + ne + "*([^\\]'\"]*?)" + ne + "*\\]", "g"), ce = new RegExp(ie),
                    _e = new RegExp("^" + re + "$"), me = {
                        ID: new RegExp("^#(" + re + ")"),
                        CLASS: new RegExp("^\\.(" + re + ")"),
                        TAG: new RegExp("^(" + re + "|[*])"),
                    ...
                    ye = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, Me = /[+~]/, Le = /'|\\/g,
                    ge = new RegExp("\\\\([\\da-f]{1,6}" + ne + "?|(" + ne + ")|.)", "ig"), ve = function (e, t, n) {
                        var r = "0x" + t - 65536;
                ...
                v = t.support = {}, w = t.isXML = function (e) {
                    ...
                    var n = Y.attrHandle[t.toLowerCase()],
                        r = n && $.call(Y.attrHandle, t.toLowerCase()) ? n(e, t, !P) : void 0;
                    ...
                    filter: {
                        TAG: function (e) {
                            ...
                            return 1 === r && 0 === a ? function (e) {
                                ...
                                var d, l, c, _, m, h, f = i !== s ? "nextSibling" : "previousSibling", p = t.parentNode,
                                    y = o && t.nodeName.toLowerCase(), M = !u && !o, L = !1;
                                if (p) {
                                    if (i) {
                                        for (; f;) {
        ...
        ye.Callbacks = function (e) {
            ...
            Deferred: function (e) {
                ...
                var t, n, r, a = 0, i = ue.call(arguments), s = i.length,
                    o = 1 !== s || e && ye.isFunction(e.promise) ? s : 0, u = 1 === o ? e : ye.Deferred(),
                    d = function (e, n, r) {
                        return function (a) {
        ...
        var Ne = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source,
            ze = new RegExp("^(?:([+-])=|)(" + Ne + ")([a-z%]*)$", "i"), Ie = ["Top", "Right", "Bottom", "Left"],
            Re = function (e, t) {
            ...
            }, qe = /^(?:checkbox|radio)$/i, Ue = /<([\w:-]+)/, Ve = /^$|\/(?:java|ecma)script/i, Ge = /^\s+/,
        ...
        ye.event = {
            ...
            trigger: function (e, t, r, a) {
                var i, s, o, u, d, l, c, _ = [r || oe], m = he.call(e, "type") ? e.type : e,
            ...
            dispatch: function (e) {
                e = ye.event.fix(e);
                var t, n, r, a, i, s = [], o = ue.call(arguments), u = (ye._data(this, "events") || {})[e.type] || [],
                    d = ye.event.special[e.type] || {};
        ...
        var rt = / jQuery\d+="(?:null|\d+)"/g, at = new RegExp("<(?:" + $e + ")[\\s/>]", "i"),
            it = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:-]+)[^>]*)\/>/gi,
            st = /<script|<style|<link/i, ot = /checked\s*(?:[^=]|=\s*.checked.)/i, ut = /^true\/(.*)/,
            dt = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g, lt = y(oe), ct = lt.appendChild(oe.createElement("div"));
        ye.extend({
        ...
        var _t, mt = {HTML: "block", BODY: "block"}, ht = /^margin/,
            ft = new RegExp("^(" + Ne + ")(?!px)[a-z%]+$", "i"), pt = function (e, t, n, r) {
                var a, i, s = {};
        ...
        var vt = /alpha\([^)]*\)/i, Yt = /opacity\s*=\s*([^)]*)/i, kt = /^(none|table(?!-c[ea]).+)/,
            wt = new RegExp("^(" + Ne + ")(.*)$", "i"),
            Dt = {position: "absolute", visibility: "hidden", display: "block"},
            Tt = {letterSpacing: "0", fontWeight: "400"}, bt = ["Webkit", "O", "Moz", "ms"],
        ...
        ye.extend({
            ...
            get: function (e, t) {
                ...
                var n = e.style, r = e.currentStyle, a = ye.isNumeric(t) ? "alpha(opacity=" + 100 * t + ")" : "",
        ...
        ye.Animation = ye.extend(G, {
            ...
            fadeTo: function (e, t, n, r) {
                ...
                return e !== !1 && (e = e || "fx"), this.each(function () {
                    var t, n = ye._data(this), r = n[e + "queue"], a = n[e + "queueHooks"], i = ye.timers,
                        s = r ? r.length : 0;
            ...
            var e, t = oe.createElement("input"), n = oe.createElement("div"), r = oe.createElement("select"),
                a = r.appendChild(oe.createElement("option"));
        ...
        var qt = n.location, Ut = ye.now(), Vt = /\?/,
        ...
        var $t = /#.*$/, Bt = /([?&])_=[^&]*/, Xt = /^(.*?):[ \t]*([^\r\n]*)\r?$/gm,
            ...
            an = qt.href, sn = en.exec(an.toLowerCase()) || [];
        ye.extend({
            active: 0,
            lastModified: {},
            etag: {},
            ...
            ajax: function (e, t) {
                ...
                var a, i, s, o, u, d, l, c, _ = ye.ajaxSetup({}, t), m = _.context || _,
                    h = _.context && (m.nodeType || m.jquery) ? ye(m) : ye.event, f = ye.Deferred(),
                    p = ye.Callbacks("once memory"), y = _.statusCode || {}, M = {}, L = {}, g = 0, v = "canceled",
                    Y = {
        ...
        a = u.extend({
            init: function (e, t, n, r) {
                ...
                if (this.tmplProps) e = this.tmplProps; else {
                    var t = d.compile(this.tmplStr, this.env.asyncFilters, this.env.extensionsList, this.path, this.env.opts),
                        n = new Function(t);
                    e = n()
                }
        ...
        var a = n(1), i = n(8), s = {
            abs: function (e) {
                ...
                var r = n === !0 ? ' rel="nofollow"' : "", a = /^(?:\(|<|&lt;)?(.*?)(?:\.|,|\)|\n|&gt;)?$/,
                    i = /^[\w.!#$%&'*+\-\/=?\^`{|}~]+@[a-z\d\-]+(\.[a-z\d\-]+)+$/i, s = /^https?:\/\/.*$/, o = /^www\./,
                    u = /\.(?:org|net|com)(?:\:|\/|$)/, d = e.split(/(\s+)/).filter(function (e) {
                        return e && e.length
                    }).map(function (e) {
    ...
    (function (e) {
        !function (t, n) {
            ...
            function Re(e) {
                var t = N(e), n = t.year || 0, r = t.quarter || 0, a = t.month || 0, i = t.week || 0, s = t.day || 0,
            ...
            function Ue(e, t) {
                var n = (t || "").match(e) || [], r = n[n.length - 1] || [], a = (r + "").match(ca) || ["-", 0, 0],
                    i = +(60 * a[1]) + L(a[2]);
                return "+" === a[0] ? i : -i
            }
            ...
            function _t(e, t) {
                var n = e || Oe(), r = Ve(n, this).startOf("day"), a = this.diff(r, "days", !0),
                    i = a < -6 ? "sameElse" : a < -1 ? "lastWeek" : a < 0 ? "lastDay" : a < 1 ? "sameDay" : a < 2 ? "nextDay" : a < 7 ? "nextWeek" : "sameElse",
                    s = t && (w(t[i]) ? t[i]() : t[i]);
            ...
            function ar(e, t, n) {
                var r = it(e).abs(), a = ni(r.as("s")), i = ni(r.as("m")), s = ni(r.as("h")), o = ni(r.as("d")),
                    u = ni(r.as("M")), d = ni(r.as("y")),
                    l = a < ri.s && ["s", a] || i <= 1 && ["m"] || i < ri.m && ["mm", i] || s <= 1 && ["h"] || s < ri.h && ["hh", s] || o <= 1 && ["d"] || o < ri.d && ["dd", o] || u <= 1 && ["M"] || u < ri.M && ["MM", u] || d <= 1 && ["y"] || ["yy", d];
            ...
            var hr, fr, pr = {}, yr = {},
                Mr = /(\[[^\[]*\])|(\\)?([Hh]mm(ss)?|Mo|MM?M?M?|Do|DDDo|DD?D?D?|ddd?d?|do?|w[o|w]?|W[o|W]?|Qo?|YYYYYY|YYYYY|YYYY|YY|gg(ggg?)?|GG(GGG?)?|e|E|a|A|hh?|HH?|kk?|mm?|ss?|S{1,9}|x|X|zz?|ZZ?|.)/g,
                Lr = /(\[[^\[]*\])|(\\)?(LTS|LT|LL?L?L?|l{1,4})/g, gr = {}, vr = {}, Yr = /\d/, kr = /\d\d/,
                wr = /\d{3}/, Dr = /\d{4}/, Tr = /[+-]?\d{6}/, br = /\d\d?/, xr = /\d\d\d\d?/, Sr = /\d\d\d\d\d\d?/,
                Hr = /\d{1,3}/, jr = /\d{1,4}/, Er = /[+-]?\d{1,6}/, Ar = /\d+/, Pr = /[+-]?\d+/,
                Wr = /Z|[+-]\d\d:?\d\d/gi, Cr = /Z|[+-]\d\d(?::?\d\d)?/gi, Fr = /[+-]?\d+(\.\d{1,3})?/,
                Or = /[0-9]*['a-z\u00A0-\u05FF\u0700-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]+|[\u0600-\u06FF\/]+(\s*?[\u0600-\u06FF]+){1,2}/i,
                Nr = {}, zr = {}, Ir = 0, Rr = 1, Jr = 2, qr = 3, Ur = 4, Vr = 5, Gr = 6, $r = 7, Br = 8;
            ...
            var Xr = /D[oD]?(\[[^\[\]]*\]|\s+)+MMMM?/,
                ...
                Qr = "Jan_Feb_Mar_Apr_May_Jun_Jul_Aug_Sep_Oct_Nov_Dec".split("_"), Zr = Or, ea = Or,
                ...
                ia = [["HH:mm:ss.SSSS", /\d\d:\d\d:\d\d\.\d+/], ["HH:mm:ss,SSSS", /\d\d:\d\d:\d\d,\d+/], ["HH:mm:ss", /\d\d:\d\d:\d\d/], ["HH:mm", /\d\d:\d\d/], ["HHmmss.SSSS", /\d\d\d\d\d\d\.\d+/], ["HHmmss,SSSS", /\d\d\d\d\d\d,\d+/], ["HHmmss", /\d\d\d\d\d\d/], ["HHmm", /\d\d\d\d/], ["HH", /\d\d/]],
                sa = /^\/?Date\((\-?\d+)/i;
            ...
            var La = "Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"),
                ga = "Sun_Mon_Tue_Wed_Thu_Fri_Sat".split("_"), va = "Su_Mo_Tu_We_Th_Fr_Sa".split("_"), Ya = Or, ka = Or,
                wa = Or;
            ...
            var za = Math.abs, Ia = Zn("ms"), Ra = Zn("s"), Ja = Zn("m"), qa = Zn("h"), Ua = Zn("d"), Va = Zn("w"),
                Ga = Zn("M"), $a = Zn("y"), Ba = tr("milliseconds"), Xa = tr("seconds"), Ka = tr("minutes"),
                Qa = tr("hours"), Za = tr("days"), ei = tr("months"), ti = tr("years"), ni = Math.round,
                ri = {s: 45, m: 45, h: 22, d: 26, M: 11}, ai = Math.abs, ii = Re.prototype;
    ...
    !function (e, t) {
        ...
        var r = "leden_únor_březen_duben_květen_červen_červenec_srpen_září_říjen_listopad_prosinec".split("_"),
            a = "led_úno_bře_dub_kvě_čvn_čvc_srp_zář_říj_lis_pro".split("_"), i = e.defineLocale("cs", {
                months: r,
                monthsShort: a,
    ...
    !function (e, t) {
        ...
        var t = ["ޖެނުއަރީ", "ފެބްރުއަރީ", "މާރިޗު", "އޭޕްރީލު", "މޭ", "ޖޫން", "ޖުލައި", "އޯގަސްޓު", "ސެޕްޓެމްބަރު", "އޮކްޓޯބަރު", "ނޮވެމްބަރު", "ޑިސެމްބަރު"],
            n = ["އާދިއްތަ", "ހޯމަ", "އަންގާރަ", "ބުދަ", "ބުރާސްފަތި", "ހުކުރު", "ހޮނިހިރު"], r = e.defineLocale("dv", {
                months: t,
                monthsShort: t,
                weekdays: n,
                weekdaysShort: n,
    ...
    !function (e, t) {
        ...
        var t = "ene._feb._mar._abr._may._jun._jul._ago._sep._oct._nov._dic.".split("_"),
            n = "ene_feb_mar_abr_may_jun_jul_ago_sep_oct_nov_dic".split("_"), r = e.defineLocale("es", {
    ...
    !function (e, t) {
        ...
        var t = "jan._feb._mrt._apr._mei_jun._jul._aug._sep._okt._nov._dec.".split("_"),
            n = "jan_feb_mrt_apr_mei_jun_jul_aug_sep_okt_nov_dec".split("_"), r = e.defineLocale("nl", {
    ...
    !function (e, t) {
        ...
        var r = "január_február_marec_apríl_máj_jún_júl_august_september_október_november_december".split("_"),
            a = "jan_feb_mar_apr_máj_jún_júl_aug_sep_okt_nov_dec".split("_"), i = e.defineLocale("sk", {
                months: r,
                monthsShort: a,
    ...
    !function (s) {
        ...
        var i, s, o = !1, u = "[object OperaMini]" === Object.prototype.toString.call(window.operamini),
            d = "placeholder" in document.createElement("input") && !u && !o,
            l = "placeholder" in document.createElement("textarea") && !u && !o, c = e.valHooks, _ = e.propHooks,
            m = {};
