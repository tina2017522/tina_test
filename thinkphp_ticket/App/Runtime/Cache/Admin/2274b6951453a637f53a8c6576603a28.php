<?php if (!defined('THINK_PATH')) exit();?><form id="pagerForm" action="/thinkphp_ticket/index.php/Admin/Hall/index" method="post">
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="add" href="/thinkphp_ticket/index.php/Admin/Hall/add" target="dialog" width="550" height="380" rel="user_msg" title="添加会员信息"><span>添加</span></a></li>
			<li><a class="delete" href="/thinkphp_ticket/index.php/Admin/Hall/del/id/<?php echo (C("TMPL_L_DELIM")); ?>item_id<?php echo (C("TMPL_R_DELIM")); ?>/navTabId/halllist" target="ajaxTodo" title="确定要删除吗?"><span>删除</span></a></li>
			<li><a class="edit" href="/thinkphp_ticket/index.php/Admin/Hall/edit/id/<?php echo (C("TMPL_L_DELIM")); ?>item_id<?php echo (C("TMPL_R_DELIM")); ?>"  width="550" height="380" target="dialog"><span>修改</span></a></li>
	...
	<table class="list" width="100%" layoutH="112">
		<thead>
			<tr>
				...
				<th width="150"  orderField="title">标题</th>
				<th width="150">所属影院</th>
				<th width="150">放映厅类型</th>
				<th width="150">座位数量</th>
				<th width="150">座位布局</th>
				<th width="150">状态</th>
		...
		<tbody>
			<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr target="item_id" rel="<?php echo ($vo["id"]); ?>">
					...
					<td><?php echo (getconfig("HALL_TYPE_LIST",$vo["htype"])); ?></td>
