<?php if (!defined('THINK_PATH')) exit();?><form id="pagerForm" action="/thinkphp_ticket/index.php/Admin/Vipuser/index" method="post">
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="add" href="/thinkphp_ticket/index.php/Admin/Vipuser/add" target="dialog" width="550" height="380" rel="user_msg" title="添加会员信息"><span>添加</span></a></li>
			<li><a class="delete" href="/thinkphp_ticket/index.php/Admin/Vipuser/del/id/<?php echo (C("TMPL_L_DELIM")); ?>item_id<?php echo (C("TMPL_R_DELIM")); ?>/navTabId/vipuserlist" target="ajaxTodo" title="确定要删除吗?"><span>删除</span></a></li>
			<li><a class="edit" href="/thinkphp_ticket/index.php/Admin/Vipuser/edit/id/<?php echo (C("TMPL_L_DELIM")); ?>item_id<?php echo (C("TMPL_R_DELIM")); ?>"  width="550" height="380" target="dialog"><span>修改</span></a></li>
	...
	<table class="list" width="100%" layoutH="112">
		<thead>
			<tr>
				...
				<th width="150"  orderField="account" <?php if($_REQUEST['_order']== 'account'): ?>class="<?php echo ($_REQUEST['_sort']); ?>"<?php endif; ?>>账号</th>
				<th width="150">头像</th>
		...
		<tbody>
			<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr target="item_id" rel="<?php echo ($vo["id"]); ?>">
					...
					<td><img src="/thinkphp_ticket/Public/Uploads/vipuser/<?php echo ($vo["picname"]); ?>"/></td>
